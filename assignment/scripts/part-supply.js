...
console.log('The second item in the supply changes array: ', secondItem);
...
console.log('Item removed from end of array: ', removedItem);
console.log('Array after item has been removed', supplyChanges);

// 5. A delivery of 25 more parts arrived. Add the value 25 to the end of the array
console.log('5. Add the value 25 into supplyChanges.');
supplyChanges.push(25);
console.log('Supply changes array with 25 added to the end: ', supplyChanges);
...
console.log('original array:', supplyChanges);
console.log('positive numbers in original array:', positives);
console.log('negative numbers in original array:', negatives);
console.log('zeroes in original array: ', zeroes);
...
console.log('original array:', supplyChanges);
console.log('positive numbers in original array:'  ,stretchPositives);
console.log('negative numbers in original array:', stretchNegatives);
console.log('zeroes in original array: ', stretchZeroes);
...
console.log('Number of total parts in supply changes array: ', totalParts);
...
while(parts > partsPerBox) {
  parts = parts - partsPerBox; 
  boxesFilled += 1;
}
console.log('The number of parts left over: ', parts);
console.log('The nuymber of full boxes: ', boxesFilled);
